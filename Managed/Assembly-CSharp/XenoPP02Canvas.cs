...
public class XenoPP02Canvas : StCanvas, StRunnable, MediaListener
{
	// Token: 0x060002D6 RID: 726 RVA: 0x00034464 File Offset: 0x00032664
	public XenoPP02Canvas()
	{
	...
	// Token: 0x060002D7 RID: 727 RVA: 0x00038607 File Offset: 0x00036807
	...
	// Token: 0x060002D8 RID: 728 RVA: 0x00038618 File Offset: 0x00036818
	...
	// Token: 0x060002D9 RID: 729 RVA: 0x00038688 File Offset: 0x00036888
	...
	// Token: 0x060002DA RID: 730 RVA: 0x0003869C File Offset: 0x0003689C
	...
	// Token: 0x060002DB RID: 731 RVA: 0x00038700 File Offset: 0x00036900
	...
	// Token: 0x060002DC RID: 732 RVA: 0x00038738 File Offset: 0x00036938
	...
	// Token: 0x060002DD RID: 733 RVA: 0x00038859 File Offset: 0x00036A59
	...
	// Token: 0x060002DE RID: 734 RVA: 0x00038869 File Offset: 0x00036A69
	public virtual int GetSeqNo()
	{
		return this.seq_no;
	}

	// Token: 0x060002DF RID: 735 RVA: 0x00038871 File Offset: 0x00036A71
	public virtual void SetSeqStep(int step)
	{
		this.seq_step_b = step;
	}

	// Token: 0x060002E0 RID: 736 RVA: 0x0003887C File Offset: 0x00036A7C
	...
	// Token: 0x060002E1 RID: 737 RVA: 0x00038899 File Offset: 0x00036A99
	public virtual int GetSeqStep()
	{
		return this.seq_step;
	}

	// Token: 0x060002E2 RID: 738 RVA: 0x000388A4 File Offset: 0x00036AA4
	...
	// Token: 0x060002E3 RID: 739 RVA: 0x0003896C File Offset: 0x00036B6C
	public virtual void Game_loop()
	{
		...
		{
			if (XenoPP02Canvas.auth_ret == 100)
			{
				this.Paint(base.GetGraphics());
				if (this.parent.chk_mem)
				{
					XenoPP02Canvas.auth_ret = this.CheckUser();
				}
				else
				{
					XenoPP02Canvas.auth_ret = 1;
				}
				if (XenoPP02Canvas.auth_ret == 1)
				{
					this.SetSeqNo(1);
				}
			}
			if (XenoPP02Canvas.auth_ret <= 0 && (this.id_edge & 4112) != 0)
			{
				this.GameEnd();
			}
			else if (XenoPP02Canvas.auth_ret == 2 && (this.id_edge & 4112) != 0)
			{
				this.AutoUpData();
			}
		}
		...
		else if (seqNo == 10)
		{
			...
			for (int i = 0; i < 6; i++)
			{
				short[] archive = XenoPP02Canvas.GetArchive(this.readbuf, i);
		...
		else if (seqNo == 12)
		{
			...
			short[] archive2 = XenoPP02Canvas.GetArchive(this.readbuf, 0);
	...
	// Token: 0x060002E4 RID: 740 RVA: 0x00038D64 File Offset: 0x00036F64
	...
	// Token: 0x060002E5 RID: 741 RVA: 0x00038E68 File Offset: 0x00037068
	...
	// Token: 0x060002E6 RID: 742 RVA: 0x00039A48 File Offset: 0x00037C48
	...
	// Token: 0x060002E7 RID: 743 RVA: 0x00039A9F File Offset: 0x00037C9F
	public virtual void SetBgm(int id)
	{
		this.nowbgm = id;
	}

	// Token: 0x060002E8 RID: 744 RVA: 0x00039AA8 File Offset: 0x00037CA8
	public virtual bool IsNowBgm(int id)
	{
		return this.nowbgm == id;
	}

	// Token: 0x060002E9 RID: 745 RVA: 0x00039AB6 File Offset: 0x00037CB6
	public virtual bool IsPlayBgm()
	{
		return this.playbgm != -1;
	}

	// Token: 0x060002EA RID: 746 RVA: 0x00039AC4 File Offset: 0x00037CC4
	...
	// Token: 0x060002EB RID: 747 RVA: 0x00039B04 File Offset: 0x00037D04
	...
	// Token: 0x060002EC RID: 748 RVA: 0x00039B43 File Offset: 0x00037D43
	...
	// Token: 0x060002ED RID: 749 RVA: 0x00039B5C File Offset: 0x00037D5C
	...
	// Token: 0x060002EE RID: 750 RVA: 0x00039BAA File Offset: 0x00037DAA
	protected internal virtual void PlaySound(int flg, int id)
	{
		this.PlaySound(flg, id, 1, 1);
	}

	// Token: 0x060002EF RID: 751 RVA: 0x00039BB6 File Offset: 0x00037DB6
	protected internal virtual void PlaySound(int flg, int id, int loop)
	{
		this.PlaySound(flg, id, loop, 1);
	}

	// Token: 0x060002F0 RID: 752 RVA: 0x00039BC4 File Offset: 0x00037DC4
	...
	// Token: 0x060002F1 RID: 753 RVA: 0x00039C90 File Offset: 0x00037E90
	...
	// Token: 0x060002F2 RID: 754 RVA: 0x00039CE0 File Offset: 0x00037EE0
	...
	// Token: 0x060002F3 RID: 755 RVA: 0x00039D14 File Offset: 0x00037F14
	public virtual int GetConfig(int no)
	{
		return this.config[no];
	}

	// Token: 0x060002F4 RID: 756 RVA: 0x00039D20 File Offset: 0x00037F20
	...
	// Token: 0x060002F5 RID: 757 RVA: 0x00039D96 File Offset: 0x00037F96
	...
	// Token: 0x060002F6 RID: 758 RVA: 0x00039DBC File Offset: 0x00037FBC
	...
	// Token: 0x060002F7 RID: 759 RVA: 0x00039DE4 File Offset: 0x00037FE4
	...
	// Token: 0x060002F8 RID: 760 RVA: 0x00039E1C File Offset: 0x0003801C
	...
	// Token: 0x060002F9 RID: 761 RVA: 0x00039E7D File Offset: 0x0003807D
	public virtual void DrawString(StGraphics g, string str, int x, int y, int anc)
	{
		this.DrawString(g, str, x, y, anc, true);
	}

	// Token: 0x060002FA RID: 762 RVA: 0x00039E90 File Offset: 0x00038090
	...
	// Token: 0x06000303 RID: 771 RVA: 0x0003A16C File Offset: 0x0003836C
	...
	// Token: 0x06000304 RID: 772 RVA: 0x0003A1A0 File Offset: 0x000383A0
	public virtual void EnemySet(int encp)
	{
		int num = this.EneEncP[encp];
		int rand = this.GetRand(0, 99);
		int num2 = -1;
		int i;
		for (i = 0; i < num; i++)
		{
			if (rand <= this.EneEncount[encp][i][0])
			{
				num2 = i;
				break;
			}
		...
		this.ep = 0;
		i = 0;
		while (i < 4 && this.EneEncount[encp][num2][1 + i * 3] != -1)
		{
			int num3 = this.EneEncount[encp][num2][1 + i * 3];
			this.SetEnemyStatus2(i, 0, num3);
			for (int j = 1; j < 32; j++)
			{
				this.SetEnemyStatus2(i, j, this.EneParam[num3][j - 1]);
			}
			this.SetEnemyStatus2(i, 32, this.EneEncount[encp][num2][2 + i * 3]);
			this.SetEnemyStatus2(i, 33, this.EneEncount[encp][num2][3 + i * 3]);
	...
	// Token: 0x06000305 RID: 773 RVA: 0x0003A2D4 File Offset: 0x000384D4
	public virtual void StatusInit()
	{
		...
		this.SetEquip(3, 22, 48);
	}

	// Token: 0x06000306 RID: 774 RVA: 0x0003A470 File Offset: 0x00038670
	...
	// Token: 0x06000307 RID: 775 RVA: 0x0003A4FC File Offset: 0x000386FC
	...
	// Token: 0x06000308 RID: 776 RVA: 0x0003A534 File Offset: 0x00038734
	...
	// Token: 0x06000309 RID: 777 RVA: 0x0003A644 File Offset: 0x00038844
	...
	// Token: 0x0600030A RID: 778 RVA: 0x0003A68B File Offset: 0x0003888B
	...
	// Token: 0x0600030B RID: 779 RVA: 0x0003A6C0 File Offset: 0x000388C0
	...
	// Token: 0x0600030C RID: 780 RVA: 0x0003A6F4 File Offset: 0x000388F4
	...
	// Token: 0x0600030D RID: 781 RVA: 0x0003A934 File Offset: 0x00038B34
	public virtual void DrawDebug(StGraphics g)
	{
	}

	// Token: 0x0600030E RID: 782 RVA: 0x0003A938 File Offset: 0x00038B38
	...
	// Token: 0x0600030F RID: 783 RVA: 0x0003ABD0 File Offset: 0x00038DD0
	...
	// Token: 0x06000310 RID: 784 RVA: 0x0003BBC4 File Offset: 0x00039DC4
	...
	// Token: 0x06000311 RID: 785 RVA: 0x0003BF34 File Offset: 0x0003A134
	...
	// Token: 0x06000312 RID: 786 RVA: 0x0003C078 File Offset: 0x0003A278
	...
	// Token: 0x06000313 RID: 787 RVA: 0x0003C398 File Offset: 0x0003A598
	...
	// Token: 0x06000314 RID: 788 RVA: 0x0003C658 File Offset: 0x0003A858
	...
	// Token: 0x06000315 RID: 789 RVA: 0x0003C85A File Offset: 0x0003AA5A
	...
	// Token: 0x06000316 RID: 790 RVA: 0x0003C88C File Offset: 0x0003AA8C
	...
	// Token: 0x06000317 RID: 791 RVA: 0x0003CA80 File Offset: 0x0003AC80
	...
	// Token: 0x06000318 RID: 792 RVA: 0x0003CBCC File Offset: 0x0003ADCC
	...
	// Token: 0x06000319 RID: 793 RVA: 0x0003CD58 File Offset: 0x0003AF58
	...
	// Token: 0x0600031A RID: 794 RVA: 0x0003CDE4 File Offset: 0x0003AFE4
	...
	// Token: 0x0600031B RID: 795 RVA: 0x0003CF70 File Offset: 0x0003B170
	...
	// Token: 0x0600031C RID: 796 RVA: 0x0003CFF4 File Offset: 0x0003B1F4
	...
	// Token: 0x0600031D RID: 797 RVA: 0x0003D124 File Offset: 0x0003B324
	...
	// Token: 0x0600031E RID: 798 RVA: 0x0003D35C File Offset: 0x0003B55C
	...
	// Token: 0x0600031F RID: 799 RVA: 0x0003D3F0 File Offset: 0x0003B5F0
	...
	// Token: 0x06000320 RID: 800 RVA: 0x0003D460 File Offset: 0x0003B660
	...
	// Token: 0x06000321 RID: 801 RVA: 0x0003D538 File Offset: 0x0003B738
	...
	// Token: 0x06000322 RID: 802 RVA: 0x0003D85C File Offset: 0x0003BA5C
	...
	// Token: 0x06000323 RID: 803 RVA: 0x0003DA94 File Offset: 0x0003BC94
	...
	// Token: 0x06000324 RID: 804 RVA: 0x0003DC08 File Offset: 0x0003BE08
	...
	// Token: 0x06000325 RID: 805 RVA: 0x0003DC9C File Offset: 0x0003BE9C
	public virtual void DrawBattleEtherEffectRecover(StGraphics g)
	{
		...
		if (num3 == 0 || num3 == 2 || num3 == 7 || num3 == 6)
		{
			...
			else
			{
				...
				if (this.GetEnemyStatus(num2, 0) == 2)
				{
					num7 -= 16;
				}
			}
	...
	// Token: 0x06000326 RID: 806 RVA: 0x0003DE18 File Offset: 0x0003C018
	...
	// Token: 0x06000327 RID: 807 RVA: 0x0003DED0 File Offset: 0x0003C0D0
	...
	// Token: 0x06000328 RID: 808 RVA: 0x0003DF43 File Offset: 0x0003C143
	...
	// Token: 0x06000329 RID: 809 RVA: 0x0003DF7F File Offset: 0x0003C17F
	...
	// Token: 0x0600032A RID: 810 RVA: 0x0003DFBB File Offset: 0x0003C1BB
	...
	// Token: 0x0600032B RID: 811 RVA: 0x0003DFF8 File Offset: 0x0003C1F8
	...
	// Token: 0x0600032C RID: 812 RVA: 0x0003E248 File Offset: 0x0003C448
	...
	// Token: 0x0600032D RID: 813 RVA: 0x0003E2B4 File Offset: 0x0003C4B4
	...
	// Token: 0x0600032E RID: 814 RVA: 0x0003E31C File Offset: 0x0003C51C
	...
	// Token: 0x0600032F RID: 815 RVA: 0x0003E3AC File Offset: 0x0003C5AC
	...
	// Token: 0x06000330 RID: 816 RVA: 0x0003E4CC File Offset: 0x0003C6CC
	...
	// Token: 0x06000331 RID: 817 RVA: 0x0003E9B8 File Offset: 0x0003CBB8
	public virtual void DrawBattleAttackEffect(StGraphics g)
	{
		...
		if (this.GetEnemyStatus(num, 0) == 2)
		{
			num3 -= 16;
		}
		if (this.attackef == 0)
		...
		else if (this.attackef == 2)
		{
			if (this.GetEnemyStatus(num, 0) == 2)
			{
				num3 = this.GetEnemyStatus(num, 33);
			}
			num2 -= 19;
			num3 -= 78;
			num3 -= 80;
	...
	// Token: 0x06000332 RID: 818 RVA: 0x0003EC10 File Offset: 0x0003CE10
	public virtual void DrawBattleSpAttackEffect(StGraphics g)
	{
		...
		case 0:
		{
			...
			if (this.GetEnemyStatus(num3, 0) == 2)
			{
				num6 -= 16;
			}
			if (this.GetEnemyStatus(num3, 2) == 0)
	...
	// Token: 0x06000333 RID: 819 RVA: 0x0003FD70 File Offset: 0x0003DF70
	...
	// Token: 0x06000334 RID: 820 RVA: 0x0003FFD0 File Offset: 0x0003E1D0
	...
	// Token: 0x06000335 RID: 821 RVA: 0x0004021C File Offset: 0x0003E41C
	...
	// Token: 0x06000336 RID: 822 RVA: 0x0004028A File Offset: 0x0003E48A
	...
	// Token: 0x06000337 RID: 823 RVA: 0x000402AC File Offset: 0x0003E4AC
	...
	// Token: 0x06000338 RID: 824 RVA: 0x0004064C File Offset: 0x0003E84C
	...
	// Token: 0x06000339 RID: 825 RVA: 0x00040728 File Offset: 0x0003E928
	...
	// Token: 0x0600033A RID: 826 RVA: 0x00040978 File Offset: 0x0003EB78
	...
	// Token: 0x0600033B RID: 827 RVA: 0x000409B3 File Offset: 0x0003EBB3
	...
	// Token: 0x0600033C RID: 828 RVA: 0x000409D0 File Offset: 0x0003EBD0
	public virtual void DrawMapTips(StGraphics g)
	{
		...
		if ((this.decieveFlag || this.sysred || this.compred || this.window_cnt != 5) && (this.decieveFlag || this.red || this.sysred))
		{
			...
			if (this.mapno == 15)
			{
				this.SetColor(g, 16719484);
				if (this.xscr.sc_flg[79] == 1)
				{
					this.DrawLine(g, 4, 4, 235, 4);
					this.DrawLine(g, 4, 4, 4, 240);
					this.DrawLine(g, 235, 4, 235, 240);
				}
				if (this.xscr.sc_flg[77] == 1)
				{
					this.DrawLine(g, 11, 11, 228, 11);
					this.DrawLine(g, 11, 11, 11, 240);
					this.DrawLine(g, 228, 11, 228, 240);
				}
				if (this.xscr.sc_flg[76] == 1)
				{
					this.DrawLine(g, 15, 16, 223, 16);
				}
				if (this.xscr.sc_flg[75] == 1)
				{
					this.FillRect(g, 15, 19, 209, 3);
				}
				if (this.xscr.sc_flg[74] == 1)
				{
					this.FillRect(g, 15, 23, 209, 2);
				}
				if (this.xscr.sc_flg[73] == 1)
				{
					this.DrawLine(g, 15, 26, 223, 26);
				}
				if (this.xscr.sc_flg[72] == 1)
				{
					this.FillRect(g, 15, 28, 209, 2);
				}
				if (this.xscr.sc_flg[71] == 1)
				{
					this.DrawLine(g, 15, 31, 223, 31);
				}
				if (this.xscr.sc_flg[70] == 1)
				{
					int num = 1;
					if (this.xscr.sc_flg[69] == 1)
					{
						num = 2;
					}
					if (this.xscr.sc_flg[68] == 1)
					{
						num = 3;
					}
					if (this.xscr.sc_flg[67] == 1)
					{
						num = 4;
					}
					if (this.xscr.sc_flg[66] == 1)
					{
						num = 5;
					}
					if (this.xscr.sc_flg[65] == 1)
					{
						num = 6;
					}
					if (this.xscr.sc_flg[64] == 1)
					{
						num = 7;
					}
					if (this.xscr.sc_flg[63] == 1)
					{
						num = 8;
					}
					if (this.xscr.sc_flg[62] == 1)
					{
						num = 9;
					}
					if (this.xscr.sc_flg[61] == 1)
					{
						num = 10;
					}
					if (this.xscr.sc_flg[60] == 1)
					{
						num = 11;
					}
					...
					if (this.xscr.sc_flg[15] == 1)
					{
						num = 13;
					}
					if (this.xscr.sc_flg[16] == 1)
					{
						num = 14;
					}
					for (int i = 0; i < num; i++)
					{
						this.DrawLine(g, 15, 36 + i * 8, 223, 36 + i * 8);
						this.DrawLine(g, 15, 36 + (27 - i) * 8, 223, 36 + (27 - i) * 8);
						this.DrawLine(g, 20 + i * 8, 32, 20 + i * 8, 260);
						this.DrawLine(g, 20 + (25 - i) * 8, 32, 20 + (25 - i) * 8, 260);
					}
				}
			}
			this.DrawScrObj(g, 0);
			...
			if (this.mapno == 15 && this.xscr.sc_flg[17] == 1)
			{
				for (int j = 0; j < 30; j++)
				{
					for (int k = 0; k < 30; k++)
					{
						this.DrawImage(g, this.sysimg[44], (int)((short)(k * 8)), (int)((short)(j * 8)), 0);
					}
				}
			}
		}
	...
	// Token: 0x0600033D RID: 829 RVA: 0x00040DE0 File Offset: 0x0003EFE0
	...
	// Token: 0x0600033E RID: 830 RVA: 0x00040E74 File Offset: 0x0003F074
	...
	// Token: 0x0600033F RID: 831 RVA: 0x00040FBA File Offset: 0x0003F1BA
	...
	// Token: 0x06000340 RID: 832 RVA: 0x00040FF0 File Offset: 0x0003F1F0
	...
	// Token: 0x06000341 RID: 833 RVA: 0x000410CC File Offset: 0x0003F2CC
	...
	// Token: 0x06000342 RID: 834 RVA: 0x0004129C File Offset: 0x0003F49C
	...
	// Token: 0x06000343 RID: 835 RVA: 0x0004146C File Offset: 0x0003F66C
	...
	// Token: 0x06000344 RID: 836 RVA: 0x00041554 File Offset: 0x0003F754
	...
	// Token: 0x06000345 RID: 837 RVA: 0x00041708 File Offset: 0x0003F908
	...
	// Token: 0x06000346 RID: 838 RVA: 0x0004178C File Offset: 0x0003F98C
	...
	// Token: 0x06000347 RID: 839 RVA: 0x00041818 File Offset: 0x0003FA18
	...
	// Token: 0x06000348 RID: 840 RVA: 0x000418A4 File Offset: 0x0003FAA4
	...
	// Token: 0x06000349 RID: 841 RVA: 0x000418C6 File Offset: 0x0003FAC6
	...
	// Token: 0x0600034A RID: 842 RVA: 0x000418EC File Offset: 0x0003FAEC
	...
	// Token: 0x0600034B RID: 843 RVA: 0x00041914 File Offset: 0x0003FB14
	...
	// Token: 0x0600034C RID: 844 RVA: 0x00041970 File Offset: 0x0003FB70
	protected internal static short[] GetArchive(sbyte[] data, int id)
	{
		...
		short num = 0;
		int num2 = 8;
		XenoPP02Canvas.ArrayShort(data, 4);
		int num3 = (int)XenoPP02Canvas.ArrayShort(data, 6);
		for (int i = 0; i < num3; i++)
		{
			short num4 = XenoPP02Canvas.ArrayShort(data, num2 + i * 6);
			if (flag)
			{
				if (num4 != num + 1)
				{
			...
			{
				short num5 = XenoPP02Canvas.ArrayShort(data, num2 + i * 6 + 2);
				short num6 = XenoPP02Canvas.ArrayShort(data, num2 + i * 6 + 4);
	...
	// Token: 0x0600034D RID: 845 RVA: 0x00041A18 File Offset: 0x0003FC18
	protected internal static int[] GetArchive2(sbyte[] data, int id)
	{
		...
		for (int i = 0; i < num3; i++)
		{
			int num4 = (int)XenoPP02Canvas.ArrayShort(data, num2 + i * 6);
			if (flag)
			{
				if (num4 != num + 1)
				{
			...
			{
				int num5 = (int)XenoPP02Canvas.ArrayShort(data, num2 + i * 6 + 2);
				int num6 = (int)XenoPP02Canvas.ArrayShort(data, num2 + i * 6 + 4);
				if (num5 < 0)
				{
					num5 += 32768;
					num5 |= 32768;
	...
	// Token: 0x0600034E RID: 846 RVA: 0x00041AE8 File Offset: 0x0003FCE8
	...
	// Token: 0x0600034F RID: 847 RVA: 0x00041B38 File Offset: 0x0003FD38
	...
	// Token: 0x06000350 RID: 848 RVA: 0x00041B8C File Offset: 0x0003FD8C
	...
	// Token: 0x06000351 RID: 849 RVA: 0x00041BBC File Offset: 0x0003FDBC
	...
	// Token: 0x06000352 RID: 850 RVA: 0x00041DB8 File Offset: 0x0003FFB8
	...
	// Token: 0x06000353 RID: 851 RVA: 0x00041F6C File Offset: 0x0004016C
	...
	// Token: 0x06000354 RID: 852 RVA: 0x00041FFA File Offset: 0x000401FA
	...
	// Token: 0x06000355 RID: 853 RVA: 0x00042034 File Offset: 0x00040234
	protected internal virtual void SetVisualData(int vno)
	{
		...
		try
		{
			...
			int[] array = XenoPP02Canvas.GetArchive2(resource, 0);
			...
			if (num > 0)
			{
				...
				for (int i = 0; i < num; i++)
				{
					array = XenoPP02Canvas.GetArchive2(resource, i + 1);
					int num2 = array[0];
					int num3 = array[1];
	...
	// Token: 0x06000356 RID: 854 RVA: 0x00042120 File Offset: 0x00040320
	protected internal virtual void ReadVisualData(int vno)
	{
		...
		try
		{
			...
			if (num > 0)
			{
				...
				for (int i = 0; i < num; i++)
				{
					int[] archive = XenoPP02Canvas.GetArchive2(resource, i);
					int num2 = archive[0];
					int num3 = archive[1];
					this.vimg[i] = this.BuildImage(resource, num2, num3);
				}
	...
	// Token: 0x06000357 RID: 855 RVA: 0x000421C0 File Offset: 0x000403C0
	protected internal virtual void ReadVisualData2(int vno)
	{
		...
		try
		{
			...
			int[] archive = XenoPP02Canvas.GetArchive2(array, this.vpno);
			int num2 = archive[0];
			int num3 = archive[1];
			...
			if (num > 0)
			{
				...
				for (int i = 0; i < num; i++)
				{
					int[] archive2 = XenoPP02Canvas.GetArchive2(array, i);
					num2 = archive2[0];
					num3 = archive2[1];
	...
	// Token: 0x06000358 RID: 856 RVA: 0x00042294 File Offset: 0x00040494
	protected internal virtual void ReleaseVisualData()
	{
		this.vimg = null;
	}

	// Token: 0x06000359 RID: 857 RVA: 0x000422A0 File Offset: 0x000404A0
	protected internal virtual void SetMapData(int mno)
	{
		this.SetLoading(true);
		sbyte[] array = this.GetResource2(this.mdfile[mno]);
		short[] array2 = XenoPP02Canvas.GetArchive(array, 0);
		this.xscr.script = new sbyte[(int)array2[1]];
		Array.Copy(array, (int)array2[0], this.xscr.script, 0, (int)array2[1]);
		array2 = XenoPP02Canvas.GetArchive(array, 1);
		this.mapw = (int)XenoPP02Canvas.ArrayShort2(array, (int)array2[0]);
		this.maph = (int)XenoPP02Canvas.ArrayShort2(array, (int)(array2[0] + 2));
		...
		if (this.befmo != num3)
		{
			...
			array = this.GetResource2(17);
			for (int i = 0; i < 72; i++)
			{
				int[] archive = XenoPP02Canvas.GetArchive2(array, i);
				int num5 = archive[0];
				int num6 = archive[1];
				this.mcimg[i] = this.BuildImage(array, num5, num6);
			}
			array = this.GetResource2(this.mofile[num3]);
			for (int i = 72; i < num4; i++)
			{
				int[] archive2 = XenoPP02Canvas.GetArchive2(array, i);
				int num5 = archive2[0];
				int num6 = archive2[1];
	...
	// Token: 0x0600035A RID: 858 RVA: 0x000424A0 File Offset: 0x000406A0
	...
	// Token: 0x0600035B RID: 859 RVA: 0x000425E0 File Offset: 0x000407E0
	...
	// Token: 0x0600035C RID: 860 RVA: 0x00042754 File Offset: 0x00040954
	...
	// Token: 0x0600035D RID: 861 RVA: 0x00042A40 File Offset: 0x00040C40
	...
	// Token: 0x0600035E RID: 862 RVA: 0x00042A64 File Offset: 0x00040C64
	...
	// Token: 0x0600035F RID: 863 RVA: 0x00042CA0 File Offset: 0x00040EA0
	...
	// Token: 0x06000360 RID: 864 RVA: 0x00042EF8 File Offset: 0x000410F8
	...
	// Token: 0x06000361 RID: 865 RVA: 0x00043148 File Offset: 0x00041348
	...
	// Token: 0x06000362 RID: 866 RVA: 0x0004337C File Offset: 0x0004157C
	...
	// Token: 0x06000363 RID: 867 RVA: 0x000433B8 File Offset: 0x000415B8
	...
	// Token: 0x06000364 RID: 868 RVA: 0x0004350C File Offset: 0x0004170C
	...
	// Token: 0x06000365 RID: 869 RVA: 0x00043538 File Offset: 0x00041738
	...
	// Token: 0x06000366 RID: 870 RVA: 0x00043564 File Offset: 0x00041764
	...
	// Token: 0x06000367 RID: 871 RVA: 0x00043590 File Offset: 0x00041790
	...
	// Token: 0x06000368 RID: 872 RVA: 0x000435BC File Offset: 0x000417BC
	...
	// Token: 0x06000369 RID: 873 RVA: 0x000435E0 File Offset: 0x000417E0
	public virtual int GetEtherDmg(int id, int en, int pow)
	{
		...
		int rand = this.GetRand(40, 50);
		int num = 10;
		int num2 = (etherAttackNum - edef) * rand * num;
		if (num2 < 0)
		{
			num2 = 0;
		}
	...
	// Token: 0x0600036A RID: 874 RVA: 0x00043657 File Offset: 0x00041857
	...
	// Token: 0x0600036B RID: 875 RVA: 0x00043686 File Offset: 0x00041886
	...
	// Token: 0x0600036C RID: 876 RVA: 0x000436C0 File Offset: 0x000418C0
	...
	// Token: 0x0600036D RID: 877 RVA: 0x00043710 File Offset: 0x00041910
	...
	// Token: 0x0600036E RID: 878 RVA: 0x00043724 File Offset: 0x00041924
	...
	// Token: 0x0600036F RID: 879 RVA: 0x0004381C File Offset: 0x00041A1C
	public virtual void StartFade(int type)
	{
		this.StartFade(type, 16);
	}

	// Token: 0x06000370 RID: 880 RVA: 0x00043828 File Offset: 0x00041A28
	...
	// Token: 0x06000371 RID: 881 RVA: 0x0004390C File Offset: 0x00041B0C
	...
	// Token: 0x06000372 RID: 882 RVA: 0x000439BC File Offset: 0x00041BBC
	...
	// Token: 0x06000373 RID: 883 RVA: 0x00043B4C File Offset: 0x00041D4C
	...
	// Token: 0x06000374 RID: 884 RVA: 0x00043B68 File Offset: 0x00041D68
	...
	// Token: 0x06000375 RID: 885 RVA: 0x00043B7C File Offset: 0x00041D7C
	...
	// Token: 0x06000376 RID: 886 RVA: 0x00043BE8 File Offset: 0x00041DE8
	...
	// Token: 0x06000377 RID: 887 RVA: 0x00043F54 File Offset: 0x00042154
	...
	// Token: 0x06000378 RID: 888 RVA: 0x00043FC6 File Offset: 0x000421C6
	...
	// Token: 0x06000379 RID: 889 RVA: 0x00043FD8 File Offset: 0x000421D8
	...
	// Token: 0x0600037A RID: 890 RVA: 0x00044064 File Offset: 0x00042264
	...
	// Token: 0x0600037B RID: 891 RVA: 0x00044074 File Offset: 0x00042274
	...
	// Token: 0x0600037C RID: 892 RVA: 0x000440A4 File Offset: 0x000422A4
	...
	// Token: 0x0600037D RID: 893 RVA: 0x000440D4 File Offset: 0x000422D4
	...
	// Token: 0x0600037E RID: 894 RVA: 0x00044132 File Offset: 0x00042332
	...
	// Token: 0x0600037F RID: 895 RVA: 0x00044144 File Offset: 0x00042344
	...
	// Token: 0x06000380 RID: 896 RVA: 0x000441C8 File Offset: 0x000423C8
	...
	// Token: 0x06000381 RID: 897 RVA: 0x00044310 File Offset: 0x00042510
	...
	// Token: 0x06000382 RID: 898 RVA: 0x0004445C File Offset: 0x0004265C
	...
	// Token: 0x06000383 RID: 899 RVA: 0x000446E3 File Offset: 0x000428E3
	public virtual bool DataFolderCheck()
	{
		return XenoPP02Canvas.LoadRecord(16) >= 4;
	}

	// Token: 0x06000384 RID: 900 RVA: 0x000446F4 File Offset: 0x000428F4
	public virtual int DataWebDownOne(int no)
	{
		...
		if (num3 == 0)
		{
			try
			{
				OutputStream outputStream = Connector.OpenOutputStream("scratchpad:///10;pos=" + num.ToString());
	...
	// Token: 0x06000385 RID: 901 RVA: 0x00044958 File Offset: 0x00042B58
	public virtual void DataReadRoutine()
	{
		...
		case 2:
			...
			if (this.work[0] == 1)
			{
				...
				{
					this.work[1]++;
					XenoPP02Canvas.StoreRecord(16, this.work[1]);
		...
		case 9:
			if (this.work[0] == 0)
			{
				...
				if (this.work[5] == 0)
				{
					this.readbuf = this.GetResource2(39);
					this.work[2] = 99;
				}
				else if (this.work[5] == 1)
				{
				...
				{
					this.readbuf = this.GetResource2(41 + this.work[5] - 6);
					this.work[2] = 1;
				}
			}
			if (this.work[0] == 1)
			{
				...
				if (this.work[5] < 5)
				{
					array = XenoPP02Canvas.GetArchive2(this.readbuf, num2);
				}
				else if (this.work[5] == 5)
				{
					array = XenoPP02Canvas.GetArchive2(this.readbuf, num2 + 17);
				}
				else
				{
					array = XenoPP02Canvas.GetArchive2(this.readbuf, 0);
				}
				int num3 = array[0];
				int num4 = array[1];
				if (this.work[5] == 0)
	...
	// Token: 0x06000386 RID: 902 RVA: 0x00044EBC File Offset: 0x000430BC
	...
	// Token: 0x06000387 RID: 903 RVA: 0x00044F64 File Offset: 0x00043164
	...
	// Token: 0x06000388 RID: 904 RVA: 0x000450E8 File Offset: 0x000432E8
	...
	// Token: 0x06000389 RID: 905 RVA: 0x00045270 File Offset: 0x00043470
	...
	// Token: 0x0600038A RID: 906 RVA: 0x0004540C File Offset: 0x0004360C
	...
	// Token: 0x0600038B RID: 907 RVA: 0x000456BE File Offset: 0x000438BE
	...
	// Token: 0x0600038C RID: 908 RVA: 0x000456CD File Offset: 0x000438CD
	public virtual void PngFadeStop()
	{
		this.pfflag = 0;
	}

	// Token: 0x0600038D RID: 909 RVA: 0x000456D8 File Offset: 0x000438D8
	...
	// Token: 0x0600038E RID: 910 RVA: 0x00045850 File Offset: 0x00043A50
	...
	// Token: 0x0600038F RID: 911 RVA: 0x00045938 File Offset: 0x00043B38
	...
	// Token: 0x06000390 RID: 912 RVA: 0x00045AD4 File Offset: 0x00043CD4
	...
	// Token: 0x06000391 RID: 913 RVA: 0x00045CB0 File Offset: 0x00043EB0
	...
	// Token: 0x06000392 RID: 914 RVA: 0x00045D70 File Offset: 0x00043F70
	...
	// Token: 0x06000393 RID: 915 RVA: 0x00045F34 File Offset: 0x00044134
	...
	// Token: 0x06000394 RID: 916 RVA: 0x000466E8 File Offset: 0x000448E8
	...
	// Token: 0x06000395 RID: 917 RVA: 0x00046964 File Offset: 0x00044B64
	...
	// Token: 0x06000396 RID: 918 RVA: 0x000469A4 File Offset: 0x00044BA4
	...
	// Token: 0x06000397 RID: 919 RVA: 0x00047430 File Offset: 0x00045630
	...
	// Token: 0x06000398 RID: 920 RVA: 0x00047598 File Offset: 0x00045798
	...
	// Token: 0x06000399 RID: 921 RVA: 0x00047680 File Offset: 0x00045880
	...
	// Token: 0x0600039A RID: 922 RVA: 0x00047708 File Offset: 0x00045908
	...
	// Token: 0x0600039B RID: 923 RVA: 0x000477F0 File Offset: 0x000459F0
	...
	// Token: 0x0600039C RID: 924 RVA: 0x00047860 File Offset: 0x00045A60
	...
	// Token: 0x0600039D RID: 925 RVA: 0x00047C53 File Offset: 0x00045E53
	public virtual void SetEncountNum()
	{
		this.encount = this.GetRand(80, 100);
	}

	// Token: 0x0600039E RID: 926 RVA: 0x00047C68 File Offset: 0x00045E68
	...
	// Token: 0x0600039F RID: 927 RVA: 0x00047D0C File Offset: 0x00045F0C
	...
	// Token: 0x060003A0 RID: 928 RVA: 0x00047DA0 File Offset: 0x00045FA0
	...
	// Token: 0x060003A1 RID: 929 RVA: 0x00047DE8 File Offset: 0x00045FE8
	...
	// Token: 0x060003A2 RID: 930 RVA: 0x00047E40 File Offset: 0x00046040
	...
	// Token: 0x060003A3 RID: 931 RVA: 0x00047EC8 File Offset: 0x000460C8
	...
	// Token: 0x060003A4 RID: 932 RVA: 0x00047F60 File Offset: 0x00046160
	...
	// Token: 0x060003A5 RID: 933 RVA: 0x00047FA4 File Offset: 0x000461A4
	...
	// Token: 0x060003A6 RID: 934 RVA: 0x00048020 File Offset: 0x00046220
	...
	// Token: 0x060003A7 RID: 935 RVA: 0x00048068 File Offset: 0x00046268
	...
	// Token: 0x060003A8 RID: 936 RVA: 0x00048140 File Offset: 0x00046340
	...
	// Token: 0x060003A9 RID: 937 RVA: 0x0004846C File Offset: 0x0004666C
	...
	// Token: 0x060003AA RID: 938 RVA: 0x000484C6 File Offset: 0x000466C6
	public virtual int GetPlyAglNum(int id)
	{
		return (this.GetAgl(id) - this.GetStatus(id, 24)) * (this.GetStatus(id, 0) + 1);
	}

	// Token: 0x060003AB RID: 939 RVA: 0x000484E4 File Offset: 0x000466E4
	public virtual int GetEneAglNum(int id)
	{
		return this.GetAgl(id + 4);
	}

	// Token: 0x060003AC RID: 940 RVA: 0x000484F0 File Offset: 0x000466F0
	...
	// Token: 0x060003AD RID: 941 RVA: 0x0004855C File Offset: 0x0004675C
	...
	// Token: 0x060003AE RID: 942 RVA: 0x000485C8 File Offset: 0x000467C8
	...
	// Token: 0x060003AF RID: 943 RVA: 0x00048660 File Offset: 0x00046860
	...
	// Token: 0x060003B0 RID: 944 RVA: 0x000486E8 File Offset: 0x000468E8
	...
	// Token: 0x060003B1 RID: 945 RVA: 0x00048761 File Offset: 0x00046961
	public virtual void EnemyDamage()
	{
		this.HpDec(this.cur[1] + 4, this.work[0]);
	}

	// Token: 0x060003B2 RID: 946 RVA: 0x0004877C File Offset: 0x0004697C
	...
	// Token: 0x060003B3 RID: 947 RVA: 0x000487BC File Offset: 0x000469BC
	...
	// Token: 0x060003B4 RID: 948 RVA: 0x0004885B File Offset: 0x00046A5B
	...
	// Token: 0x060003B5 RID: 949 RVA: 0x0004889C File Offset: 0x00046A9C
	...
	// Token: 0x060003B6 RID: 950 RVA: 0x00048938 File Offset: 0x00046B38
	...
	// Token: 0x060003B7 RID: 951 RVA: 0x0004897C File Offset: 0x00046B7C
	...
	// Token: 0x060003B8 RID: 952 RVA: 0x000489B8 File Offset: 0x00046BB8
	...
	// Token: 0x060003B9 RID: 953 RVA: 0x00048A04 File Offset: 0x00046C04
	...
	// Token: 0x060003BA RID: 954 RVA: 0x00048B94 File Offset: 0x00046D94
	...
	// Token: 0x060003BB RID: 955 RVA: 0x00048D58 File Offset: 0x00046F58
	...
	// Token: 0x060003BC RID: 956 RVA: 0x00048F4C File Offset: 0x0004714C
	...
	// Token: 0x060003BD RID: 957 RVA: 0x00049003 File Offset: 0x00047203
	...
	// Token: 0x060003BE RID: 958 RVA: 0x00049024 File Offset: 0x00047224
	...
	// Token: 0x060003BF RID: 959 RVA: 0x00049044 File Offset: 0x00047244
	...
	// Token: 0x060003C0 RID: 960 RVA: 0x0004905D File Offset: 0x0004725D
	...
	// Token: 0x060003C1 RID: 961 RVA: 0x00049072 File Offset: 0x00047272
	...
	// Token: 0x060003C2 RID: 962 RVA: 0x0004909C File Offset: 0x0004729C
	...
	// Token: 0x060003C3 RID: 963 RVA: 0x00049104 File Offset: 0x00047304
	...
	// Token: 0x060003C4 RID: 964 RVA: 0x000491C4 File Offset: 0x000473C4
	...
	// Token: 0x060003C5 RID: 965 RVA: 0x00049250 File Offset: 0x00047450
	...
	// Token: 0x060003C6 RID: 966 RVA: 0x00049358 File Offset: 0x00047558
	public virtual int Status2id(int st, int f)
	{
		...
		int rand = this.GetRand(0, 98);
		int num4 = 0;
		for (int i = 0; i < num2; i++)
		{
			int num5 = (num2 + 1 - (i + 1)) * 100 / num3;
			if (rand < num5 + num4)
			{
				num = this.branks[i];
				break;
	...
	// Token: 0x060003C7 RID: 967 RVA: 0x000493CC File Offset: 0x000475CC
	...
	// Token: 0x060003C8 RID: 968 RVA: 0x000493F8 File Offset: 0x000475F8
	...
	// Token: 0x060003C9 RID: 969 RVA: 0x00049434 File Offset: 0x00047634
	public virtual void EnemyAttackInit()
	{
		...
		else
		{
			...
			if (this.GetEnemyStatus(num2, 13 + num3) == 8 && ((this.GetEnemyStatus(0, 3) > 0 && this.GetEnemyStatus(2, 3) > 0) || this.enecnt >= 5))
			{
				this.eneatk = 48;
			}
		}
	...
	// Token: 0x060003CA RID: 970 RVA: 0x00049858 File Offset: 0x00047A58
	public virtual void ConfusionAttackInit()
	{
		int num = this.GetGtw(0);
		int rand = this.GetRand(0, 1);
		this.nowmenu = rand;
		bool flag;
		int rand2;
		do
		{
			...
			if (this.cur[0] == 0)
			{
				rand2 = this.GetRand(0, this.ep - 1);
				if (rand2 != 255 && this.GetEnemyStatus(rand2, 34) == 0)
				{
					flag = false;
				}
			}
			...
			{
				int rand3 = this.GetRand(0, 3);
				rand2 = this.GetRanks(rand3);
				if (rand2 != 255 && this.GetStatus(rand2, 20) == 0 && this.GetStatus(rand2, 19) == 0)
				{
					flag = false;
				}
			}
	...
	// Token: 0x060003CB RID: 971 RVA: 0x00049944 File Offset: 0x00047B44
	...
	// Token: 0x060003CC RID: 972 RVA: 0x00049A10 File Offset: 0x00047C10
	...
	// Token: 0x060003CD RID: 973 RVA: 0x00049B24 File Offset: 0x00047D24
	...
	// Token: 0x060003CE RID: 974 RVA: 0x00049B64 File Offset: 0x00047D64
	...
	// Token: 0x060003CF RID: 975 RVA: 0x00049B88 File Offset: 0x00047D88
	...
	// Token: 0x060003D0 RID: 976 RVA: 0x00049BB4 File Offset: 0x00047DB4
	...
	// Token: 0x060003D1 RID: 977 RVA: 0x00049BD6 File Offset: 0x00047DD6
	public virtual void BattleRedraw(int no)
	{
		this.bred[no] = true;
	}

	// Token: 0x060003D2 RID: 978 RVA: 0x00049BE1 File Offset: 0x00047DE1
	public virtual void BattleRedrawN(int no)
	{
		this.bredn[no] = true;
	}

	// Token: 0x060003D3 RID: 979 RVA: 0x00049BEC File Offset: 0x00047DEC
	...
	// Token: 0x060003D4 RID: 980 RVA: 0x00049C00 File Offset: 0x00047E00
	...
	// Token: 0x060003D5 RID: 981 RVA: 0x00049C14 File Offset: 0x00047E14
	...
	// Token: 0x060003D6 RID: 982 RVA: 0x00049C2C File Offset: 0x00047E2C
	...
	// Token: 0x060003D7 RID: 983 RVA: 0x00049C51 File Offset: 0x00047E51
	...
	// Token: 0x060003D8 RID: 984 RVA: 0x00049C72 File Offset: 0x00047E72
	...
	// Token: 0x060003D9 RID: 985 RVA: 0x00049C92 File Offset: 0x00047E92
	...
	// Token: 0x060003DA RID: 986 RVA: 0x00049CB8 File Offset: 0x00047EB8
	...
	// Token: 0x060003DB RID: 987 RVA: 0x00049CD9 File Offset: 0x00047ED9
	...
	// Token: 0x060003DC RID: 988 RVA: 0x00049CFE File Offset: 0x00047EFE
	...
	// Token: 0x060003DD RID: 989 RVA: 0x00049D1E File Offset: 0x00047F1E
	...
	// Token: 0x060003DE RID: 990 RVA: 0x00049D4B File Offset: 0x00047F4B
	...
	// Token: 0x060003DF RID: 991 RVA: 0x00049D73 File Offset: 0x00047F73
	...
	// Token: 0x060003E0 RID: 992 RVA: 0x00049DA0 File Offset: 0x00047FA0
	...
	// Token: 0x060003E1 RID: 993 RVA: 0x00049DC8 File Offset: 0x00047FC8
	...
	// Token: 0x060003E2 RID: 994 RVA: 0x00049E08 File Offset: 0x00048008
	...
	// Token: 0x060003E3 RID: 995 RVA: 0x00049E44 File Offset: 0x00048044
	...
	// Token: 0x060003E4 RID: 996 RVA: 0x00049E65 File Offset: 0x00048065
	...
	// Token: 0x060003E5 RID: 997 RVA: 0x00049E7E File Offset: 0x0004807E
	...
	// Token: 0x060003E6 RID: 998 RVA: 0x00049E9E File Offset: 0x0004809E
	...
	// Token: 0x060003E7 RID: 999 RVA: 0x00049EBF File Offset: 0x000480BF
	...
	// Token: 0x060003E8 RID: 1000 RVA: 0x00049EE8 File Offset: 0x000480E8
	public virtual void BattleInit()
	{
		...
		for (int i = 0; i < 7; i++)
		{
			int[] archive = XenoPP02Canvas.GetArchive2(this.readbuf, i);
			num = archive[0];
			num2 = archive[1];
			this.eneimg[i] = this.BuildImage(this.readbuf, num, num2);
		}
		if (0 <= this.mapno && this.mapno <= 5)
		{
		...
		int[] archive2 = XenoPP02Canvas.GetArchive2(this.readbuf, 0);
		num = archive2[0];
		num2 = archive2[1];
		...
		else if (0 <= this.mapno && this.mapno <= 5)
		{
			this.EnemySet(0);
		}
		else
		...
		this.StopAllSound();
		if (this.battleno == 4 || this.battleno == 3)
		{
			this.SetBgm(3);
		}
		else
	...
	// Token: 0x060003E9 RID: 1001 RVA: 0x0004A12C File Offset: 0x0004832C
	...
	// Token: 0x060003EA RID: 1002 RVA: 0x0004D1D0 File Offset: 0x0004B3D0
	...
	// Token: 0x060003EB RID: 1003 RVA: 0x0004D310 File Offset: 0x0004B510
	...
	// Token: 0x060003EC RID: 1004 RVA: 0x0004D470 File Offset: 0x0004B670
	...
	// Token: 0x060003ED RID: 1005 RVA: 0x0004D5D4 File Offset: 0x0004B7D4
		...
		else
		{
			...
			if (this.work[2] == 8)
			{
				for (int i = 0; i < 3; i++)
				{
					if (this.GetEnemyStatus(i, 3) <= 0)
					{
						if (this.ep < 3 && this.GetEnemyStatus(i, 34) == 0)
						{
							this.ep++;
						}
						this.SetEnemyStatus2(i, 0, 2);
						for (int j = 1; j < 32; j++)
						{
							this.SetEnemyStatus2(i, j, this.EneParam[2][j - 1]);
						}
						this.SetEnemyStatus2(i, 34, 0);
						this.SetEnemyStatus2(i, 35, 0);
						this.SetEnemyStatus2(i, 36, 0);
						this.SetEnemyStatus2(i, 37, 1);
						this.SetEnemyStatus2(i, 38, this.GetEnemyStatus2(i, 3));
						this.SetEnemyStatus2(i, 39, 0);
						this.enecnt++;
						return;
	...
	// Token: 0x060003EE RID: 1006 RVA: 0x0004D7CC File Offset: 0x0004B9CC
	...
	// Token: 0x060003EF RID: 1007 RVA: 0x0004D8B0 File Offset: 0x0004BAB0
	...
	// Token: 0x060003F0 RID: 1008 RVA: 0x0004D904 File Offset: 0x0004BB04
	...
	// Token: 0x060003F1 RID: 1009 RVA: 0x0004DA04 File Offset: 0x0004BC04
	...
	// Token: 0x060003F2 RID: 1010 RVA: 0x0004DB04 File Offset: 0x0004BD04
	...
	// Token: 0x060003F3 RID: 1011 RVA: 0x0004DB86 File Offset: 0x0004BD86
	...
	// Token: 0x060003F4 RID: 1012 RVA: 0x0004DBAD File Offset: 0x0004BDAD
	...
	// Token: 0x060003F5 RID: 1013 RVA: 0x0004DBD0 File Offset: 0x0004BDD0
	...
	// Token: 0x060003F6 RID: 1014 RVA: 0x0004DC60 File Offset: 0x0004BE60
	...
	// Token: 0x060003F7 RID: 1015 RVA: 0x0004DCD0 File Offset: 0x0004BED0
	...
	// Token: 0x060003F8 RID: 1016 RVA: 0x0004DCF0 File Offset: 0x0004BEF0
	...
	// Token: 0x060003F9 RID: 1017 RVA: 0x0004DD65 File Offset: 0x0004BF65
	public virtual int GetNowSlot()
	{
		return this.bslot[this.bslotno];
	}

	// Token: 0x060003FA RID: 1018 RVA: 0x0004DD74 File Offset: 0x0004BF74
	...
	// Token: 0x060003FB RID: 1019 RVA: 0x0004DDA4 File Offset: 0x0004BFA4
	...
	// Token: 0x060003FC RID: 1020 RVA: 0x0004DDE0 File Offset: 0x0004BFE0
	...
	// Token: 0x060003FD RID: 1021 RVA: 0x0004DE34 File Offset: 0x0004C034
	...
	// Token: 0x060003FE RID: 1022 RVA: 0x0004DE90 File Offset: 0x0004C090
	...
	// Token: 0x060003FF RID: 1023 RVA: 0x0004E168 File Offset: 0x0004C368
	...
	// Token: 0x06000400 RID: 1024 RVA: 0x0004E1F8 File Offset: 0x0004C3F8
	...
	// Token: 0x06000401 RID: 1025 RVA: 0x0004E270 File Offset: 0x0004C470
	...
	// Token: 0x06000402 RID: 1026 RVA: 0x0004E39C File Offset: 0x0004C59C
	...
	// Token: 0x06000403 RID: 1027 RVA: 0x0004E4B0 File Offset: 0x0004C6B0
	...
	// Token: 0x06000404 RID: 1028 RVA: 0x0004E4F0 File Offset: 0x0004C6F0
	...
	// Token: 0x06000405 RID: 1029 RVA: 0x0004E515 File Offset: 0x0004C715
	public virtual void AglWaitClear(int id)
	{
		this.SetStatus(id, 24, 0);
	}

	// Token: 0x06000406 RID: 1030 RVA: 0x0004E524 File Offset: 0x0004C724
	...
	// Token: 0x06000407 RID: 1031 RVA: 0x0004E700 File Offset: 0x0004C900
	...
	// Token: 0x06000408 RID: 1032 RVA: 0x0004E810 File Offset: 0x0004CA10
	...
	// Token: 0x06000409 RID: 1033 RVA: 0x0004E9DC File Offset: 0x0004CBDC
	...
	// Token: 0x0600040A RID: 1034 RVA: 0x0004EBAC File Offset: 0x0004CDAC
	public virtual void ResultRoutine()
	{
		...
		case 0:
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				if (num2 != 255)
				{
					...
					if (this.GetStatus(num2, 20) == 1 && this.GetStatus(num2, 0) + 1 < 20)
					{
						...
						do
						{
							if (this.GetStatus(num2, 15) <= 0 && this.GetStatus(num2, 0) + 1 < 20)
							{
								this.work[19 + num2]++;
								num = this.GetStatus(num2, 15) * -1;
								this.SetLevelStatus(num2, this.GetStatus(num2, 0) + 1);
								if (this.GetStatus(num2, 0) + 1 < 20)
								{
									num3 = this.GetStatus(num2, 15) - num;
									this.SetStatus(num2, 15, num3);
								}
		...
		case 3:
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				if (num2 != 255 && this.GetStatus(num2, 20) == 0 && this.GetStatus(num2, 19) == 0)
				{
					if (this.work[0] > 0 && this.GetStatus(num2, 0) + 1 < 20)
					{
	...
	// Token: 0x0600040B RID: 1035 RVA: 0x0004F444 File Offset: 0x0004D644
	...
	// Token: 0x0600040C RID: 1036 RVA: 0x0004F4D0 File Offset: 0x0004D6D0
	...
	// Token: 0x0600040D RID: 1037 RVA: 0x0004F508 File Offset: 0x0004D708
	...
	// Token: 0x0600040E RID: 1038 RVA: 0x0004F6DC File Offset: 0x0004D8DC
	...
	// Token: 0x0600040F RID: 1039 RVA: 0x0004F79C File Offset: 0x0004D99C
	...
	// Token: 0x06000410 RID: 1040 RVA: 0x0004F984 File Offset: 0x0004DB84
	...
	// Token: 0x06000411 RID: 1041 RVA: 0x0004FA28 File Offset: 0x0004DC28
	...
	// Token: 0x06000412 RID: 1042 RVA: 0x0004FAC4 File Offset: 0x0004DCC4
	...
	// Token: 0x06000413 RID: 1043 RVA: 0x0004FB40 File Offset: 0x0004DD40
	...
	// Token: 0x06000414 RID: 1044 RVA: 0x0004FCC8 File Offset: 0x0004DEC8
	...
	// Token: 0x06000415 RID: 1045 RVA: 0x0004FE90 File Offset: 0x0004E090
	...
	// Token: 0x06000416 RID: 1046 RVA: 0x000501B4 File Offset: 0x0004E3B4
	...
	// Token: 0x06000417 RID: 1047 RVA: 0x00050484 File Offset: 0x0004E684
	...
	// Token: 0x06000418 RID: 1048 RVA: 0x000504EC File Offset: 0x0004E6EC
	...
	// Token: 0x06000419 RID: 1049 RVA: 0x000505A4 File Offset: 0x0004E7A4
	...
	// Token: 0x0600041A RID: 1050 RVA: 0x0005065C File Offset: 0x0004E85C
	...
	// Token: 0x0600041B RID: 1051 RVA: 0x000506CC File Offset: 0x0004E8CC
	...
	// Token: 0x0600041C RID: 1052 RVA: 0x0005073C File Offset: 0x0004E93C
	...
	// Token: 0x0600041D RID: 1053 RVA: 0x000507A8 File Offset: 0x0004E9A8
	...
	// Token: 0x0600041E RID: 1054 RVA: 0x000507EC File Offset: 0x0004E9EC
	...
	// Token: 0x0600041F RID: 1055 RVA: 0x00050868 File Offset: 0x0004EA68
	...
	// Token: 0x06000420 RID: 1056 RVA: 0x000508E4 File Offset: 0x0004EAE4
	...
	// Token: 0x06000421 RID: 1057 RVA: 0x00050950 File Offset: 0x0004EB50
	...
	// Token: 0x06000422 RID: 1058 RVA: 0x000509A0 File Offset: 0x0004EBA0
	...
	// Token: 0x06000423 RID: 1059 RVA: 0x000509F0 File Offset: 0x0004EBF0
	public virtual int GetHitRate(int id, int id2, int hit)
	{
		int dex = this.GetDex(id);
		int rand = this.GetRand(-10, 10);
		int eva = this.GetEva(id2);
		return hit + dex + rand - eva;
	}

	// Token: 0x06000424 RID: 1060 RVA: 0x00050A1F File Offset: 0x0004EC1F
	...
	// Token: 0x06000425 RID: 1061 RVA: 0x00050A3E File Offset: 0x0004EC3E
	...
	// Token: 0x06000426 RID: 1062 RVA: 0x00050A5D File Offset: 0x0004EC5D
	...
	// Token: 0x06000427 RID: 1063 RVA: 0x00050A84 File Offset: 0x0004EC84
	...
	// Token: 0x06000428 RID: 1064 RVA: 0x00050ABC File Offset: 0x0004ECBC
	...
	// Token: 0x06000429 RID: 1065 RVA: 0x00050AF1 File Offset: 0x0004ECF1
	...
	// Token: 0x0600042A RID: 1066 RVA: 0x00050B0C File Offset: 0x0004ED0C
	...
	// Token: 0x0600042B RID: 1067 RVA: 0x00050B2C File Offset: 0x0004ED2C
	public virtual void SetMapPlayerChar(int id)
	{
		...
		if ((this.xscr.sc_flg[6] != 1 && 0 <= this.mapno && this.mapno <= 7) || (9 <= this.mapno && this.mapno <= 12))
		{
			num = 0;
		}
		if (id == 0)
	...
	// Token: 0x0600042C RID: 1068 RVA: 0x00050BCC File Offset: 0x0004EDCC
	public virtual void MapRoutine()
	{
		...
		case 1:
			...
			if (6 <= this.mapno && this.mapno <= 7 && this.ismenu[1] && this.xscr.sc_skipadr != 65535 && this.xscr.sc_skipadr > this.xscr.script_adr)
			{
				this.ismenu[1] = false;
			...
			if (this.xscr.sc_flg[6] == 1)
			{
				for (sbyte b = 0; b < 6; b += 1)
				{
					this.miflag[(int)b][0] = true;
				}
				return;
			}
			if (this.xscr.sc_flg[6] == 0)
			{
				for (sbyte b2 = 0; b2 < 6; b2 += 1)
				{
					this.miflag[(int)b2][0] = false;
				}
				return;
			}
			break;
	...
	// Token: 0x0600042D RID: 1069 RVA: 0x000527F8 File Offset: 0x000509F8
	...
	// Token: 0x0600042E RID: 1070 RVA: 0x000528A4 File Offset: 0x00050AA4
	...
	// Token: 0x0600042F RID: 1071 RVA: 0x00052A54 File Offset: 0x00050C54
	public virtual void VisualRoutine()
	{
		...
		case 0:
			...
			this.SetMenu(6);
			if (this.visualno == 1 || this.visualno == 8)
			{
				this.SetMenu(4);
			}
			this.SetSeqStep(1);
		...
		case 2:
			if (this.IsFade() == 3)
			{
				...
				if (this.mapno == 5 && this.xscr.sc_flg[47] == 1)
				{
					this.visualno = 8;
					this.SetSeqNo(8);
					return;
	...
	// Token: 0x06000430 RID: 1072 RVA: 0x00052CD0 File Offset: 0x00050ED0
	...
	// Token: 0x06000431 RID: 1073 RVA: 0x00052E00 File Offset: 0x00051000
	public virtual void TitleRoutine()
	{
		...
		case 3:
			if (this.IsFade() == 3)
			{
				...
				this.mapno = 6;
				this.SetSeqNo(6);
				if (StApplication.GetCurrentApp().GetParameter("PP0" + 1.ToString()) != null)
				{
					this.SetSeqNo(19);
					return;
				}
	...
	// Token: 0x06000432 RID: 1074 RVA: 0x000530DC File Offset: 0x000512DC
	...
	// Token: 0x06000433 RID: 1075 RVA: 0x00053194 File Offset: 0x00051394
	...
	// Token: 0x06000434 RID: 1076 RVA: 0x00053328 File Offset: 0x00051528
	...
	// Token: 0x06000435 RID: 1077 RVA: 0x00053524 File Offset: 0x00051724
	...
	// Token: 0x06000436 RID: 1078 RVA: 0x0005370C File Offset: 0x0005190C
	...
	// Token: 0x06000437 RID: 1079 RVA: 0x00053878 File Offset: 0x00051A78
	public virtual void HelpInit()
	{
		...
		sbyte[] resource = this.GetResource2(11);
		for (int i = 0; i < 66; i++)
		{
			this.mmstr[i] = string.Empty;
			this.mmenu[i] = 255;
		...
		for (int i = 0; i < this.mmenup; i++)
		{
			...
			int num3 = (int)XenoPP02Canvas.ArrayShort(resource, i * 4 + 2 + num);
	...
	// Token: 0x06000438 RID: 1080 RVA: 0x00053A38 File Offset: 0x00051C38
	...
	// Token: 0x06000439 RID: 1081 RVA: 0x00053CC4 File Offset: 0x00051EC4
	...
	// Token: 0x0600043A RID: 1082 RVA: 0x00053DBC File Offset: 0x00051FBC
	...
	// Token: 0x0600043B RID: 1083 RVA: 0x00053E94 File Offset: 0x00052094
	...
	// Token: 0x0600043C RID: 1084 RVA: 0x00053EE0 File Offset: 0x000520E0
	...
	// Token: 0x0600043D RID: 1085 RVA: 0x00054890 File Offset: 0x00052A90
	...
	// Token: 0x0600043E RID: 1086 RVA: 0x00054C88 File Offset: 0x00052E88
	...
	// Token: 0x0600043F RID: 1087 RVA: 0x00054EEC File Offset: 0x000530EC
	...
	// Token: 0x06000440 RID: 1088 RVA: 0x00054F64 File Offset: 0x00053164
	...
	// Token: 0x06000441 RID: 1089 RVA: 0x0005549C File Offset: 0x0005369C
	...
	// Token: 0x06000442 RID: 1090 RVA: 0x000555A8 File Offset: 0x000537A8
	...
	// Token: 0x06000443 RID: 1091 RVA: 0x0005560C File Offset: 0x0005380C
	...
	// Token: 0x06000444 RID: 1092 RVA: 0x00055670 File Offset: 0x00053870
	...
	// Token: 0x06000445 RID: 1093 RVA: 0x00055914 File Offset: 0x00053B14
	...
	// Token: 0x06000446 RID: 1094 RVA: 0x00055AA6 File Offset: 0x00053CA6
	protected internal virtual void SetArrayByte(sbyte[] data, int ofs, sbyte num)
	{
		data[ofs] = num;
	}

	// Token: 0x06000447 RID: 1095 RVA: 0x00055AAC File Offset: 0x00053CAC
	...
	// Token: 0x06000448 RID: 1096 RVA: 0x00055AE8 File Offset: 0x00053CE8
	...
	// Token: 0x06000449 RID: 1097 RVA: 0x00055B0C File Offset: 0x00053D0C
	protected internal virtual sbyte[] XenoSaveDataCreate()
	{
		...
		num += 4;
		this.SetArrayInt(array, num, 1);
		num += 4;
		return array;
	}

	// Token: 0x0600044A RID: 1098 RVA: 0x00055E6C File Offset: 0x0005406C
	protected internal virtual void XenoLoad()
	{
		...
		for (int i = 0; i < 4; i++)
		{
			this.SetRanks(i, XenoPP02Canvas.ArrayInt(array, num));
			num += 4;
		}
		for (int i = 0; i < 4; i++)
		{
			for (int j = 0; j < 26; j++)
			{
				this.SetStatus(i, j, XenoPP02Canvas.ArrayInt(array, num));
				num += 4;
			}
		}
		this.mapno = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.mapx = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.mapy = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.chm = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.chc = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.chx = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.chy = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		for (int i = 0; i < 66; i++)
		{
			for (int j = 0; j < 2; j++)
			{
				this.itempc[i][j] = XenoPP02Canvas.ArrayInt(array, num);
				num += 4;
			}
		}
		for (int i = 0; i < 80; i++)
		{
			this.xscr.sc_flg[i] = XenoPP02Canvas.ArrayInt(array, num);
			num += 4;
		}
		for (sbyte b = 0; b < 6; b += 1)
		{
			this.miflag[(int)b][0] = false;
		}
		if (this.xscr.sc_flg[6] == 1)
		{
			for (sbyte b = 0; b < 6; b += 1)
		...
		this.eneapr = this.miflag[this.mapno][0];
		this.rev_mapno = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.rev_mapx = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.rev_mapy = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.rev_chx = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.rev_chy = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
	}

	// Token: 0x0600044B RID: 1099 RVA: 0x00056058 File Offset: 0x00054258
	protected internal static int LoadRecord(int id)
	{
		Type typeFromHandle = typeof(XenoPP02Canvas);
		int num2;
		lock (typeFromHandle)
		{
			int num = 0;
			try
			{
				...
				DataInputStream dataInputStream = Connector.OpenDataInputStream("scratchpad:///10;" + text);
	...
	// Token: 0x0600044C RID: 1100 RVA: 0x000560DC File Offset: 0x000542DC
	protected internal virtual sbyte[] LoadRecords(int id, int len)
	{
		...
		lock (this)
		{
			...
			{
				string text = "pos=" + id.ToString();
				InputStream inputStream = Connector.OpenDataInputStream("scratchpad:///10;" + text);
				int num = 0;
	...
	// Token: 0x0600044D RID: 1101 RVA: 0x000561A4 File Offset: 0x000543A4
	protected internal static void StoreRecord(int id, int val)
	{
		...
		lock (typeFromHandle)
		{
			...
			{
				string text = "pos=" + id.ToString();
				DataOutputStream dataOutputStream = Connector.OpenDataOutputStream("scratchpad:///10;" + text);
	...
	// Token: 0x0600044E RID: 1102 RVA: 0x00056220 File Offset: 0x00054420
	protected internal void StoreRecords(int id, sbyte[] data, int len)
	{
		...
		lock (typeFromHandle)
		{
			...
			{
				string text = "pos=" + id.ToString();
				OutputStream outputStream = Connector.OpenOutputStream("scratchpad:///10;" + text);
	...
	// Token: 0x0600044F RID: 1103 RVA: 0x000562AC File Offset: 0x000544AC
	protected internal virtual void ExistSaveData()
	{
		if (XenoPP02Canvas.ArrayInt(this.LoadRecords(20, 24), 20) == 1)
		{
			this.LoadOptionData();
			this.ResetConfig();
			return;
	...
	// Token: 0x06000450 RID: 1104 RVA: 0x000562DC File Offset: 0x000544DC
	protected internal virtual void LoadOptionData()
	{
		...
		for (int i = 0; i < 4; i++)
		{
			this.config[i] = XenoPP02Canvas.ArrayInt(array, num);
			num += 4;
		}
		this.sdflag = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
		this.opflag = XenoPP02Canvas.ArrayInt(array, num);
		num += 4;
	}

	// Token: 0x06000451 RID: 1105 RVA: 0x00056338 File Offset: 0x00054538
	...
	// Token: 0x06000452 RID: 1106 RVA: 0x00056364 File Offset: 0x00054564
	...
	// Token: 0x06000453 RID: 1107 RVA: 0x000563D1 File Offset: 0x000545D1
	...
	// Token: 0x06000454 RID: 1108 RVA: 0x00056410 File Offset: 0x00054610
	...
	// Token: 0x06000455 RID: 1109 RVA: 0x00056468 File Offset: 0x00054668
	...
	// Token: 0x06000456 RID: 1110 RVA: 0x000564A8 File Offset: 0x000546A8
	...
	// Token: 0x06000457 RID: 1111 RVA: 0x00056567 File Offset: 0x00054767
	...
	// Token: 0x06000458 RID: 1112 RVA: 0x00056584 File Offset: 0x00054784
	protected internal virtual int XenoClearSend()
	{
		string[] array = new string[3];
		array[0] = "2";
		array[1] = "PP0" + 2.ToString();
	...
	// Token: 0x06000459 RID: 1113 RVA: 0x00056600 File Offset: 0x00054800
	protected internal virtual string XenoStrClearDataCreate()
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			num2 = XenoPP02Canvas.ArrayInt(array, num);
			num += 4;
			if (num2 >= 100000)
			{
				text += num2.ToString();
	...
	// Token: 0x0600045A RID: 1114 RVA: 0x0005680C File Offset: 0x00054A0C
	protected internal virtual void XenoClearLoad()
	{
		...
		try
		{
			parameter = StApplication.GetCurrentApp().GetParameter("PP0" + 1.ToString());
		}
		catch (Exception)
		{
			return;
	...
	// Token: 0x0600045B RID: 1115 RVA: 0x0005694C File Offset: 0x00054B4C
	protected internal virtual sbyte[] GetResource2(int fid)
	{
		...
		try
		{
			...
			InputStream inputStream = Connector.OpenDataInputStream("scratchpad:///10;pos=" + num.ToString() + ",length=" + num3.ToString());
	...
	// Token: 0x0600045C RID: 1116 RVA: 0x00056A90 File Offset: 0x00054C90
	...
	// Token: 0x0600045D RID: 1117 RVA: 0x00056B7C File Offset: 0x00054D7C
	private bool SaveIntSP(int val, int offset)
	{
		try
		{
			DataOutputStream dataOutputStream = Connector.OpenDataOutputStream("scratchpad:///10;pos=" + offset.ToString());
			dataOutputStream.WriteInt(val);
			dataOutputStream.Close();
		}
		catch (Exception)
	...
	// Token: 0x0600045E RID: 1118 RVA: 0x00056BC8 File Offset: 0x00054DC8
	private int LoadIntSP(int offset)
	{
		int num;
		try
		{
			DataInputStream dataInputStream = Connector.OpenDataInputStream("scratchpad:///10;pos=" + offset.ToString());
			num = dataInputStream.ReadInt();
			dataInputStream.Close();
		}
		catch (Exception)
	...
	// Token: 0x0600045F RID: 1119 RVA: 0x00056C14 File Offset: 0x00054E14
	...
	// Token: 0x06000460 RID: 1120 RVA: 0x00056CA0 File Offset: 0x00054EA0
	private void DrawUserCheck(StGraphics g)
	{
		this.SetColor(g, 0);
		this.FillRect(g, 0, 0, this.GetWidth(), this.GetHeight());
		this.SetColor(g, 16777215);
		if (XenoPP02Canvas.auth_ret == 100 || XenoPP02Canvas.auth_ret == 1)
		{
		...
		for (int i = 0; i < 4; i++)
		{
			this.DrawString(g, array[XenoPP02Canvas.auth_ret + 1][i], 12, 90 + i * 15, 0);
		}
	}

	// Token: 0x06000461 RID: 1121 RVA: 0x00056DCC File Offset: 0x00054FCC
	private void AutoUpData()
	{
	}

	// Token: 0x06000462 RID: 1122 RVA: 0x00056DCE File Offset: 0x00054FCE
	...
	protected internal XenoPP02Canvas self;

	// Token: 0x04000234 RID: 564
	public XenoPP02 parent;

	// Token: 0x04000235 RID: 565
	protected internal XScript02 xscr;
	...
	private int[] mofile = new int[] { 18, 19, 20, 21, 22 };

	// Token: 0x040002E3 RID: 739
	private int[] mofmax = new int[] { 182, 100, 88, 100, 88 };
	...
	private int[] vfile = new int[] { 24, 36, 7, 9, 38, 23, 37, 14, 35 };

	// Token: 0x040002E8 RID: 744
	private int[] vtbl = new int[] { 1, 0, 2, 1, 1, 1, 1, 1, 0 };
	...
	private string[][] dfilename = new string[][]
	{
		...
		new string[] { "bbg1", ".dat" },
		new string[] { "bbg2", ".dat" },
		new string[] { "cen_acpoint1", ".dat" },
		new string[] { "cen_acpoint2", ".dat" },
		new string[] { "cen_main", ".dat" },
		new string[] { "days_after", ".dat" },
		new string[] { "enemy", ".dat" },
		new string[] { "eri_kaikou", ".dat" },
		new string[] { "face", ".dat" },
		new string[] { "help0", ".xhf" },
		new string[] { "hs_ap", ".dat" },
		new string[] { "hs_pa2", ".dat" },
		new string[] { "inside_police", ".dat" },
		new string[] { "kasou_reihai", ".dat" },
		new string[] { "logo", ".dat" },
		new string[] { "map0", ".dat" },
		new string[] { "map1", ".dat" },
		new string[] { "map2", ".dat" },
		...
		new string[] { "pla_acc", ".dat" },
		new string[] { "pla_ent", ".dat" },
		new string[] { "pla_icu", ".dat" },
		new string[] { "pla_main", ".dat" },
		new string[] { "pp02_end", ".dat" },
		new string[] { "pp02_start", ".dat" },
	...
	private string[] EneName = new string[] { "U.M.N.ﾃﾛﾘｽﾄB", "ﾌﾟﾛﾄｶﾞｰﾃﾞｨｽ", "ｶﾞｰﾃﾞｨｽF1", "ﾌﾞﾛﾝﾃｰｽ", "U.M.N.ﾃﾛﾘｽﾄB", "U.M.N.ｺﾏﾝﾀﾞｰ", "ｽﾃﾛﾍﾞｰｽ", "ﾊﾞﾙﾄﾞﾙ", "U.M.N.ﾃﾛﾘｽﾄB" };
	...
	private int[][] EneParam = new int[][]
	{
		new int[]
		{
			3, 0, 154, 6, 11, 15, 11, 24, 21, 8,
			2, -1, 3, -1, -1, -1, -1, -1, 3, 1,
			6, 0, 0, 0, 84, 1, 4, 0, 0, 3,
			1
		},
		new int[]
		{
			0, 1, 200, 11, 13, 17, 11, 19, 13, 6,
			-1, -1, 8, -1, -1, -1, -1, -1, 5, 4,
			6, 0, 4, 4, 98, 1, 4, 4, 0, 3,
			5
		},
		new int[]
		{
			1, 0, 154, 5, 10, 8, 10, 18, 12, 7,
			0, -1, 1, -1, -1, -1, -1, -1, 5, 1,
			6, 0, 0, 0, 91, 1, 4, 12, -1, -1,
			-1
		},
		new int[]
		{
			2, 1, 246, 9, 15, 8, 14, 25, 20, 8,
			1, -1, 2, -1, -1, -1, -1, -1, 5, 1,
			1, 0, 1, 1, 122, 1, 4, 4, 0, 3,
			5
		},
		new int[]
		{
			3, 0, 175, 13, 12, 15, 11, 24, 21, 8,
			2, -1, 3, -1, -1, -1, -1, -1, 3, 1,
			6, 0, 0, 0, 109, 1, 3, 0, 0, 2,
			12
		},
		new int[]
		{
			4, 0, 181, 15, 13, 16, 11, 25, 21, 9,
			2, -1, 4, -1, -1, -1, -1, -1, 3, 1,
			6, 0, 0, 0, 116, 1, 3, 1, 0, 1,
			16
		},
		new int[]
		{
			5, 1, 314, 22, 18, 19, 14, 25, 24, 8,
			3, -1, 5, -1, -1, -1, -1, -1, 5, 1,
			6, 3, 1, 1, 143, 1, 3, 4, 0, 1,
			14
		},
		new int[]
		{
			6, 1, 1679, 26, 21, 20, 15, 41, 32, 11,
			4, -1, 6, 7, -1, -1, -1, -1, 3, 2,
			1, 3, 5, 3, 475, 1, 4, 1, 0, 1,
			15
		},
		new int[]
		{
			3, 0, 182, 8, 11, 15, 11, 24, 21, 8,
			2, -1, 3, -1, -1, -1, -1, -1, 3, 1,
			6, 0, 0, 0, 200, 1, 4, 0, 0, 3,
			1
		}
	};
	...
	{
		new int[] { 1, 7, -1, 0, 5, 50 },
		new int[] { 0, 2, -1, 0, 5, 50 },
		new int[] { 0, 1, -1, 0, 6, 50 },
		new int[] { 0, 2, -1, 0, 4, 50 },
		new int[] { 0, 9, -1, 0, 10, 50 }
	};
	...
	private string[] EneSAtkName = new string[] { "能力分析", "出力増強", "応急処置", "グレネード", "火炎放射", "応急処置", "ポイズン", "増殖", "仲間を呼ぶ" };

	// Token: 0x04000300 RID: 768
	private int[][] EneSAtkParam = new int[][]
	{
		new int[] { 1, 7, 8, 1, -1, 1, 20 },
		new int[] { 1, -1, -1, 4, -1, 1, 11 },
		new int[] { 1, -1, -1, 4, 1, 2, 26 },
		new int[] { 0, 3, -1, 1, 5, 0, 0 },
		new int[] { 0, 3, -1, 1, 6, 0, 0 },
		new int[] { 1, -1, -1, 4, 1, 2, 26 },
		new int[] { 1, 8, -1, 1, 5, 0, 17 },
		new int[] { 1, -1, -1, 4, 2, 2, 26 },
		new int[] { 0, -1, -1, 8, -1, 2, 0 }
	};

	// Token: 0x04000301 RID: 769
	private string[][] EneSAtkExp = new string[][]
	{
		new string[] { "エーテル", "全体", "Ｂ／Ｓ", "エーテル力ダウン" },
		new string[]
		{
			"エーテル",
			"自分",
	...
	private int[] EneEncP = new int[] { 5, 1, 1, 1, 5, 1 };
	...
	private int[][][] EneEncount = new int[][][]
	{
		new int[][]
		{
			new int[]
			{
				29, 0, 60, 170, 0, 120, 160, 0, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
			...
			new int[]
			{
				79, 2, 60, 170, 1, 120, 170, 2, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				89, 0, 60, 170, 3, 120, 170, 0, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				99, 3, 80, 170, 3, 160, 170, -1, -1, -1,
				-1, -1, -1
			}
		},
		new int[][] { new int[]
		{
			99, 8, 120, 170, -1, -1, -1, -1, -1, -1,
			-1, -1, -1
		} },
		new int[][] { new int[]
		{
			99, 8, 80, 170, 8, 160, 170, -1, -1, -1,
			-1, -1, -1
		} },
		new int[][] { new int[]
		{
			99, 8, 60, 170, 8, 120, 160, 8, 180, 170,
			-1, -1, -1
		} },
		new int[][]
		{
			new int[]
			{
				39, 4, 60, 170, 4, 120, 160, 4, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				59, 4, 60, 170, 6, 120, 170, 4, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				79, 5, 60, 170, 5, 120, 160, 5, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				89, 6, 60, 170, 6, 120, 170, 6, 180, 170,
				-1, -1, -1
			},
			new int[]
			{
				99, 6, 60, 170, 5, 120, 170, 6, 180, 170,
				-1, -1, -1
			}
		},
		new int[][] { new int[]
